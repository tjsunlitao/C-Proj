namespace TASITJ_3005
{
    partial class FormMain
    {
        ...
        private void InitializeComponent()
        {
            ...
            DevComponents.DotNetBar.Charts.ChartAxisY chartAxisY1 = new DevComponents.DotNetBar.Charts.ChartAxisY();
            DevComponents.DotNetBar.Charts.ChartAxisY chartAxisY2 = new DevComponents.DotNetBar.Charts.ChartAxisY();
            DevComponents.DotNetBar.Charts.ChartAxisY chartAxisY3 = new DevComponents.DotNetBar.Charts.ChartAxisY();
            DevComponents.DotNetBar.Charts.ChartAxisY chartAxisY4 = new DevComponents.DotNetBar.Charts.ChartAxisY();
            ...
            this.button_Start = new DevComponents.DotNetBar.ButtonItem();
            this.button_Calc = new DevComponents.DotNetBar.ButtonItem();
            this.button_Set = new DevComponents.DotNetBar.ButtonItem();
            this.button_History = new DevComponents.DotNetBar.ButtonItem();
            ...
            this.labelX_PLC_State = new DevComponents.DotNetBar.LabelX();
            ...
            this.bar1.Name = "bar1";
            this.bar1.Size = new System.Drawing.Size(1368, 25);
            ...
            this.button_Calc.Text = "分  析";
            this.button_Calc.Click += new System.EventHandler(this.button_Calc_Click);
            // 
            // button_Set
            // 
            this.button_Set.Name = "button_Set";
            this.button_Set.Text = "设  置";
            this.button_Set.Click += new System.EventHandler(this.button_Set_Click);
            // 
            // button_History
            // 
            this.button_History.Name = "button_History";
            this.button_History.Text = "历  史";
            ...
            // chartControl1
            // 
            chartAxisY1.Name = "AncAxisY1";
            chartAxisY1.Title.ChartTitleVisualStyle.Alignment = DevComponents.DotNetBar.Charts.Style.Alignment.TopLeft;
            chartAxisY1.Title.Name = null;
            chartAxisY1.Title.Text = "位移(毫米)";
            chartAxisY2.MajorGridLines.Visible = false;
            chartAxisY2.MinorGridLines.Visible = false;
            chartAxisY2.Name = "AncAxisY2";
            chartAxisY2.Title.ChartTitleVisualStyle.Alignment = DevComponents.DotNetBar.Charts.Style.Alignment.TopLeft;
            chartAxisY2.Title.Name = null;
            chartAxisY2.Title.Text = "压力(千牛)";
            chartAxisY3.MajorGridLines.Visible = false;
            chartAxisY3.MinorGridLines.Visible = false;
            chartAxisY3.Name = "AncAxisY3";
            chartAxisY3.Title.ChartTitleVisualStyle.Alignment = DevComponents.DotNetBar.Charts.Style.Alignment.TopLeft;
            chartAxisY3.Title.Name = null;
            chartAxisY3.Title.Text = "压强(帕)";
            chartAxisY4.MajorGridLines.Visible = false;
            chartAxisY4.MaxValue = 30;
            chartAxisY4.MinorGridLines.Visible = false;
            chartAxisY4.Name = "AncAxisY4";
            chartAxisY4.Title.ChartTitleVisualStyle.Alignment = DevComponents.DotNetBar.Charts.Style.Alignment.TopLeft;
            chartAxisY4.Title.Name = null;
            chartAxisY4.Title.Text = "速度(毫米/秒)";
            chartXy1.AncillaryAxesY.Add(chartAxisY1);
            chartXy1.AncillaryAxesY.Add(chartAxisY2);
            chartXy1.AncillaryAxesY.Add(chartAxisY3);
            chartXy1.AncillaryAxesY.Add(chartAxisY4);
            chartXy1.AutoSizeMode = DevComponents.DotNetBar.Charts.AutoSizeMode.None;
            chartXy1.AxisX.MajorGridLines.GridLinesVisualStyle.LineColor = System.Drawing.Color.WhiteSmoke;
            chartXy1.AxisX.MinorGridLines.GridLinesVisualStyle.LineColor = System.Drawing.Color.WhiteSmoke;
            chartXy1.AxisX.Title.ChartTitleVisualStyle.Alignment = DevComponents.DotNetBar.Charts.Style.Alignment.TopCenter;
            chartXy1.AxisX.Title.Name = null;
            chartXy1.AxisX.Title.Text = "时间(秒)";
            chartXy1.AxisX.UseAutoMinGridInterval = false;
            ...
            chartXy1.ChartLineDisplayMode = DevComponents.DotNetBar.Charts.ChartLineDisplayMode.DisplaySpline;
            chartSeries1.AxisY = chartAxisY1;
            chartSeries1.CrosshairHighlightPoints = DevComponents.DotNetBar.Charts.Style.Tbool.True;
            chartSeries1.EmptyValues = null;
            chartSeries1.LegendText = "位移";
        ...
        ((object)(39D))};
            ...
            chartSeries1.Tag = "";
            chartSeries2.AxisY = chartAxisY2;
            chartSeries2.EmptyValues = null;
            chartSeries2.LegendText = "压力";
            chartSeries2.Name = "Series2";
            seriesPoint11.ValueX = 0D;
            seriesPoint11.ValueY = new object[] {
        ((object)(10D))};
            seriesPoint12.ValueX = 1D;
            seriesPoint12.ValueY = new object[] {
        ((object)(1D))};
            seriesPoint13.ValueX = 2D;
            seriesPoint13.ValueY = new object[] {
        ((object)(2D))};
            seriesPoint14.ValueX = 3D;
            seriesPoint14.ValueY = new object[] {
        ((object)(3D))};
            chartSeries2.SeriesPoints.Add(seriesPoint11);
            chartSeries2.SeriesPoints.Add(seriesPoint12);
            chartSeries2.SeriesPoints.Add(seriesPoint13);
            chartSeries2.SeriesPoints.Add(seriesPoint14);
            chartSeries2.SeriesType = DevComponents.DotNetBar.Charts.SeriesType.Line;
            chartSeries3.AxisY = chartAxisY3;
            chartSeries3.EmptyValues = null;
            chartSeries3.LegendText = "压强";
            chartSeries3.Name = "Series3";
            chartSeries3.SeriesType = DevComponents.DotNetBar.Charts.SeriesType.Line;
            chartSeries4.AxisY = chartAxisY4;
            chartSeries4.EmptyValues = null;
            chartSeries4.LegendText = "速度";
            chartSeries4.Name = "Series4";
            ...
            chartXy1.FillWeight = 800;
            chartXy1.HScrollBar.ScrollBarVisualStyles.SelectedMouseOver.NoAlphaOnMouseOver = DevComponents.DotNetBar.Charts.Style.Tbool.True;
            chartXy1.HScrollBarHeight = 10;
            ...
            chartXy1.MinContentSize = new System.Drawing.Size(200, 100);
            ...
            chartXy1.VScrollBar.ScrollBarVisualStyles.MouseOver.NoAlphaOnMouseOver = DevComponents.DotNetBar.Charts.Style.Tbool.True;
            chartXy1.VScrollBarWidth = 10;
            ...
            // slider1
            // 
            this.slider1.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
            // 
            // 
            // 
            this.slider1.BackgroundStyle.CornerType = DevComponents.DotNetBar.eCornerType.Square;
            this.slider1.Location = new System.Drawing.Point(840, 1);
            this.slider1.Maximum = 8000;
            this.slider1.Name = "slider1";
            this.slider1.Size = new System.Drawing.Size(525, 23);
            ...
            // panel1
            // 
            this.panel1.Controls.Add(this.labelX_PLC_State);
            ...
            // 
            // 
            this.labelX_PLC_State.BackgroundStyle.CornerType = DevComponents.DotNetBar.eCornerType.Square;
            this.labelX_PLC_State.Location = new System.Drawing.Point(6, 1);
            this.labelX_PLC_State.Name = "labelX_PLC_State";
            this.labelX_PLC_State.Size = new System.Drawing.Size(162, 23);
            this.labelX_PLC_State.TabIndex = 6;
            this.labelX_PLC_State.Text = "PLC连接状态: 未连接";
            // 
            // timer1
            // 
        ...
        private DevComponents.DotNetBar.ButtonItem button_Set;
        private DevComponents.DotNetBar.ButtonItem button_History;
        ...
        private DevComponents.DotNetBar.ButtonItem button_Start;
        private DevComponents.DotNetBar.ButtonItem button_Calc;
        private DevComponents.DotNetBar.LabelX labelX_PLC_State;
    }
}